...
import InstructionModa from './InstructionModa';

const Cartcontainer = () => {
  const similarSlider = useRef(null);
  ...
  return (
    <>
    {modal && (
    <InstructionModa closeModal={modalHandler}>
    <div className={styles.instructionModalBox}>
     <h4>Type Instructions <Image src="/icons/close.svg" width={20} height={20} alt='close icon' unoptimized onClick={modalHandler}/></h4>
     <textarea name="user_instruction" id="user_instruction" cols="30" rows="10" placeholder='Enter Your Instructions' onChange={instructions}>{instruction}</textarea>
     <button onClick={cancleInstruction} type='button'>Cancle</button> <button onClick={saveInstructionHandler}>Save</button>
    </div>
    </InstructionModa>
    )}
    ...
    <div className={styles.container}>
      ...
      <div className={styles.discountDialouge}>
                ...
                <div className={styles.login_input}>
                    <input type="text" required="required" placeholder='Enter Coupen code'/>
                </div>
                <input type="submit" value="Submit Coupen Code" />
                <div className={styles.availabelCoupenCodeHeading} onClick={showCoupencodeHandler}>
                    <p>Availabel Coupon Code <img src="/icons/green-price-tag.svg" alt="green-price-tag icon" height={30} width={30} unoptimized/></p>
